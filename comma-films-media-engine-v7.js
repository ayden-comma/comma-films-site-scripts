/* ============================================================
   Comma Films — home-new media engine v7
   v7 changes:
...
(() => {
  ...
  document.addEventListener('click', e => {
    ...
    // rebuilt gallery: any media slide -> open dialog (vimeo, youtube, or image)
    ...
    if (slide) {
      ...
      openDialog(slide.dataset.mediaType, slide.dataset.mediaType === 'image' ? slide.dataset.mediaSrc : slide.dataset.mediaId);
      return;
    }
  ...
  function openDialog(type, ref) {
    closeDialog();
    const d = document.createElement('div'), b = document.createElement('div'), x = document.createElement('button');
    d.className = 'csvd'; b.className = 'csvd_b'; x.className = 'csvd_x'; x.ariaLabel = 'Close';
    if (type === 'image') {
      b.classList.add('csvd_b--img');
      const im = document.createElement('img'); im.className = 'csvd_img'; im.src = ref; im.alt = '';
      b.appendChild(im);
    } else {
      const f = document.createElement('iframe');
      f.src = (type === 'youtube')
        ? 'https://www.youtube.com/embed/' + ref + '?autoplay=1&rel=0'
        : 'https://player.vimeo.com/video/' + ref + '?autoplay=1&title=0&byline=0&portrait=0';
      f.setAttribute('frameborder', '0');
