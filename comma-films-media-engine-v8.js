/* ============================================================
   Comma Films — home-new media engine v8
   v8 changes:
...
(() => {
  ...
  .cf-gal-slide .cf-gal-cap{position:absolute;left:0;right:0;bottom:0;z-index:3;padding:30px 16px 13px;font-family:"Red hat display",sans-serif;font-size:14px;letter-spacing:.01em;color:#f2ede6}
  ...
  .csvd_nav{position:fixed;top:50%;transform:translateY(-50%);width:52px;height:52px;border-radius:50%;border:1px solid #ffffff38;background:#0c0c0e6b;cursor:pointer;display:grid;place-items:center;z-index:1000000;transition:background .25s}
  .csvd_nav:hover{background:var(--accent,#c8833a)}
  .csvd_nav:hover svg{stroke:#000}
  .csvd_nav svg{width:20px;height:20px;stroke:#fff;stroke-width:1.9;fill:none;stroke-linecap:round;stroke-linejoin:round}
  .csvd_prev{left:24px}.csvd_next{right:24px}
  .csvd_cap{position:fixed;left:0;right:0;bottom:26px;text-align:center;font-family:"Red hat display",sans-serif;font-size:13px;letter-spacing:.06em;color:#f2ede6cc;z-index:1000000;pointer-events:none}
  @media(max-width:600px){.csvd_nav{width:44px;height:44px}.csvd_prev{left:10px}.csvd_next{right:10px}}
  /* mobile popup chrome */
  @media(max-width:767px){
