/* ============================================================
   Comma Films — home-new media engine v15
   v15 changes:
...
(() => {
  ...
  .cf-gal-arrow{position:absolute;top:-56px;width:44px;height:44px;border-radius:50%;border:1px solid #ffffff2e;background:rgba(20,18,16,.6);cursor:pointer;display:grid;place-items:center;z-index:5;transition:background .25s,border-color .25s,opacity .25s}
  ...
  .cf-gal-arrow-prev{right:62px}.cf-gal-arrow-next{right:8px}
  ...
  .csvd_strip{display:flex;gap:16px;width:100vw;overflow-x:auto;scroll-snap-type:x mandatory;-webkit-overflow-scrolling:touch;scrollbar-width:none;padding:0 20vw;align-items:center}
  .csvd_strip::-webkit-scrollbar{display:none}
  .csvd_cell{flex:0 0 60vw;scroll-snap-align:center;height:auto;aspect-ratio:16/10;border-radius:12px;overflow:hidden;background:#0e0c0a;position:relative;display:flex;align-items:center;justify-content:center;opacity:.45;transition:opacity .3s;box-shadow:0 0 0 1px #ffffff10}
